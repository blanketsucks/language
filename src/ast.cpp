...
FunctionExpr::FunctionExpr(
    Location start, Location end, std::unique_ptr<PrototypeExpr> prototype, std::vector<std::unique_ptr<Expr>> body
) : Expr(start, end) {
...
IfExpr::IfExpr(
    Location start, Location end, std::unique_ptr<Expr> condition, std::vector<std::unique_ptr<Expr>> body, std::vector<std::unique_ptr<Expr>> ebody
) : Expr(start, end) {
